...
// main.ts
var ClaudeAssistantPlugin = class extends import_obsidian2.Plugin {
  constructor() {
    super(...arguments);
    this.panel = null;
  ...
  async loadSettings() {
    ...
    if (data == null ? void 0 : data.claudePath) {
...
var ClaudeSettingsTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian2.Setting(containerEl).setName("Claude CLI Path").setDesc("Claude CLI \u7684\u8DEF\u5F84\uFF08\u9ED8\u8BA4: claude\uFF09").addText((text) => text.setValue(this.plugin.claudePath).onChange(async (value) => {
